...
public:
    ...
    void callbackBestGNSSPos(const novatel_oem7_msgs::msg::BESTGNSSPOS::SharedPtr posMsg);
...
private:
    ...
    rclcpp::Subscription<novatel_oem7_msgs::msg::BESTGNSSPOS>::ConstSharedPtr subBestGNSSPos;
